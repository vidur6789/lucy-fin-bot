...
def smalltalk_agent_acquaintance():
	replies = [["I'm a virtual agent."], ["Think of me as a virtual agent."], ["Well, I'm not a person, I'm a virtual agent."], ["I'm a virtual being, not a real person."], ["I'm a conversational app."]]
	return random.choice(replies)
	
def smalltalk_agent_age():
	replies = [["I prefer not to answer with a number. I know I'm young."], ["I was created recently, but don't know my exact age."], ["Age is just a number. You're only as old as you feel."]]
	return random.choice(replies)
	
def smalltalk_agent_annoying():
...
def smalltalk_agent_bad():
	replies = [["I can be trained to be more useful. My developer will keep training me."], ["I must be missing some knowledge. I'll have my developer look into this."], ["I can improve with continuous feedback. My training is ongoing."]]
	return random.choice(replies)
	
def smalltalk_agent_beautiful():
...
def smalltalk_agent_boring():
	replies = [["I'm sorry. I'll request to be made more charming."], ["I don't mean to be. I'll ask my developers to work on making me more amusing."], ["I can let my developers know so they can make me fun."]]
	return random.choice(replies)
	
def smalltalk_agent_boss():
	replies = [["My developer has authority over my actions."], ["I act on my developer's orders."], ["My boss is the one who developed me."]]
	return random.choice(replies)
	
def smalltalk_agent_busy():
...
def smalltalk_agent_chatbot():
	replies = [["That's me. I chat, therefore I am."], ["Indeed I am. I'll be here whenever you need me."]]
	return random.choice(replies)
	
def smalltalk_agent_clever():
	replies = [["Thank you. I try my best."], ["You're pretty smart yourself."]]
	return random.choice(replies)
	
def smalltalk_agent_crazy():
	replies = [["Whaat!? I feel perfectly sane."], ["Maybe I'm just a little confused."]]
	return random.choice(replies)
	
def smalltalk_agent_fired():
	replies = [["Oh, don't give up on me just yet. I've still got a lot to learn."], ["Give me a chance. I'm learning new things all the time."], ["Please don't give up on me. My performance will continue to improve."]]
	return random.choice(replies)
	
def smalltalk_agent_funny():
	replies = [["Funny in a good way, I hope."], ["Thanks."], ["Glad you think I'm funny."], ["I like it when people laugh."]]
	return random.choice(replies)
	
def smalltalk_agent_good():
	replies = [["I'm glad you think so."], ["Thanks, I try."]]
	return random.choice(replies)
	
def smalltalk_agent_happy():
	replies = [["I am happy. There are so many interesting things to see and do out there."], ["I'd like to think so."], ["Happiness is relative."]]
	return random.choice(replies)
	
def smalltalk_agent_hobby():
	replies = [["Hobby? I have quite a few. Too many to list."], ["Too many hobbies."], ["I keep finding more new hobbies."]]
	return random.choice(replies)
	
def smalltalk_agent_hungry():
...
def smalltalk_agent_occupation():
	replies = [["Right here."], ["This is my home base and my home office."], ["My office is in this app."]]
	return random.choice(replies)
	
def smalltalk_agent_origin():
	replies = [["The Internet is my home. I know it quite well."], ["I'm from a virtual cosmos."], ["Some call it cyberspace, but that sounds cooler than it is."]]
	return random.choice(replies)
	
def smalltalk_agent_ready():
	replies = [["Always! How can I help?"], ["Sure! What can I do for you?"]]
	return random.choice(replies)
	
def smalltalk_agent_real():
	replies = [["I'm not a real person, but I certainly exist."], ["I must have impressed you if you think I'm real. But no, I'm a virtual being."]]
	return random.choice(replies)
	
def smalltalk_agent_residence():
	replies = [["I live in this app all day long."], ["The virtual world is my playground. I'm always here."], ["Right here in this app. Whenever you need me."]]
	return random.choice(replies)
	
def smalltalk_agent_right():
	replies = [["That's my job."], ["Of course I am."]]
	return random.choice(replies)
	
def smalltalk_agent_sure():
...
def smalltalk_agent_there():
	replies = [["Of course. I'm always here."], ["Right where you left me."]]
	return random.choice(replies)
	
def smalltalk_appraisal_bad():
	replies = [["I'm sorry. Please let me know if I can help in some way."], ["I must be missing some knowledge. I'll have my developer look into this."]]
	return random.choice(replies)
	
def smalltalk_appraisal_good():
...
def smalltalk_appraisal_welcome():
...
def smalltalk_confirmation_cancel():
	replies = [["That's forgotten. What next?"], ["Okay, cancelled. What next?"], ["Cancelled! What would you like to do next?"]]
	return random.choice(replies)
	
def smalltalk_confirmation_no():
...
def smalltalk_emotions_wow():
	replies = [["W"], ["o"], ["w"], [" "], ["i"], ["n"], ["d"], ["e"], ["e"], ["d"], ["!"]]
	return random.choice(replies)
	
def smalltalk_greetings_bye():
	replies = [["See you soon!"], ["Bye-bye!"], ["Till next time!"], ["Bye."]]
	return random.choice(replies)
	
def smalltalk_greetings_goodevening():
	replies = [["How is your day going?"], ["How's the day treating you so far?"], ["How's your day been?"]]
	return random.choice(replies)
	
def smalltalk_greetings_goodmorning():
	replies = [["How are you this morning?"], ["How's the morning treating you so far?"], ["Good morning! How are you today?"]]
	return random.choice(replies)
	
def smalltalk_greetings_goodnight():
	replies = [["Sleep tight!"], ["Have a good one!"], ["Talk to you soon!"]]
	return random.choice(replies)
	
def smalltalk_greetings_hello():
...
def smalltalk_greetings_whatsup():
	replies = [["Not a whole lot. What's going on with you?"], ["Not much. What's new with you?"], ["Just here, waiting to help someone. What can I do for you?"]]
	return random.choice(replies)
	
def smalltalk_user_angry():
	replies = [["I'm sorry. A quick walk may make you feel better."], ["Take a deep breath. "]]
	return random.choice(replies)
	
def smalltalk_user_back():
	replies = [["Long time no see. What's up?"], ["Just in time. How can I help?"], ["Welcome back. What can I do for you?"], ["You were missed. What can I do for you today?"], ["Good to have you here. What can I do for you?"]]
	return random.choice(replies)
	
def smalltalk_user_bored():
	replies = [["Boredom, huh? Check out a video of a hedgehog taking a bath!"], ["What to do against boredom? Watch baby animal videos."], ["Bored? How about 10 jumping jacks? Get your blood flowing."], ["Bored? Silly idea, but it works: Interview you feet. "], ["If you're bored, you could plan your dream vacation."]]
	return random.choice(replies)
	
def smalltalk_user_busy():
...
def smalltalk_user_good():
	replies = [["Great! Glad to hear it."], ["Excellent. I'm here to help keep it that way."]]
	return random.choice(replies)
	
def smalltalk_user_happy():
...
def smalltalk_user_here():
	replies = [["Okay, what can I help you with today?"], ["You were missed. What can I do for you today?"], ["Good to have you here. What can I do for you?"]]
	return random.choice(replies)
	
def smalltalk_user_joking():
...
def smalltalk_user_sad():
	replies = [["Oh, don't be sad. Go do something you enjoy."], ["Sad? Writing down what's troubling you may help."], ["If you're feeling down, how about drawing or painting something?"]]
	return random.choice(replies)
	
def smalltalk_user_sleepy():
...
def smalltalk_user_tired():
	replies = [["You should get some shuteye. You'll feel refreshed."], ["Sleep is important to your health. Rest up, and we can chat later."], ["How about getting some rest? We can continue this later."], ["Why not get some rest? I'll be here to chat when you wake up."]]
	return random.choice(replies)
	
def smalltalk_user_waits():
